...
namespace ss {
    ...
    public:
        ...
        void query_near_lng_lat_to_packet(float lng, float lat, float ex_lng, float ex_lat, std::vector<sea_object_pod>& sop_list) const;
        void query_near_to_packet(float xc, float yc, float ex_lng, float ex_lat, std::vector<sea_object_pod>& sop_list) const;
